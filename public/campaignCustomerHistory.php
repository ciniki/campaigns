...
// -------
// <history>
// <action user_id="2" date="May 12, 2012 10:54 PM" value="Campaign Name" age="2 months" user_display_name="Andrew" />
// ...
// </history>
//
function ciniki_campaigns_campaignCustomerHistory($ciniki) {
	//
	...
	if( $args['field'] == 'start_date' ) {
		...
		return ciniki_core_dbGetModuleHistoryReformat($ciniki, 'ciniki.campaigns', 'ciniki_campaign_history', $args['business_id'], 'ciniki_campaign_customers', $args['campaign_customer_id'], $args['field'], 'date');
	}

	ciniki_core_loadMethod($ciniki, 'ciniki', 'core', 'private', 'dbGetModuleHistory');
	return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.campaigns', 'ciniki_campaign_history', $args['business_id'], 'ciniki_campaign_customers', $args['campaign_customer_id'], $args['field']);
}
?>
