...
// </history>
//
function ciniki_campaigns_campaignHistory($ciniki) {
	//
	...
	return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.campaigns', 'ciniki_campaign_history', $args['business_id'], 'ciniki_campaigns', $args['campaign_id'], $args['field']);
}
?>
